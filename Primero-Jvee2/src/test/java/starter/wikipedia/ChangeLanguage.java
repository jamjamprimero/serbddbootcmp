...
import pageobjects.wikipedia.ValidationActions;
...
public class ChangeLanguage {
	...
	public void change_language_to_spanish() {
		...
		Serenity.reportThat("Validate Page Content Language is \"en\"",
				() -> assertThat(vac.isLanguageInfoEqualTo("en")));	
...
//				() -> assertThat(driver.u).isEqualTo("https://en.wikipedia.org/wiki/Main_Page"));	
...
//		nav.click_page_information();
		Serenity.reportThat("Validate Page Content Language is \"es\"",
				() -> assertThat(vac.isLanguageInfoEqualTo("es")));
		driver.quit();
	}
}
